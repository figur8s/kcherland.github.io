...
The acceptance rate is typically very high (>70%) compared to other methods of deriving samples like standard Metropolis or Gibbs. See more: <a href="https://github.com/figur8s/hamiltonian-monte-carlo">here</a>.  
