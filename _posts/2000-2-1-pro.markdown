...
The acceptance rate is typically very high (>70%) compared to other methods of deriving samples like standard Metropolis or Gibbs. See more: https://github.com/figur8s/hamiltonian-monte-carlo. 
